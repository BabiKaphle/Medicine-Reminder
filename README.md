...
- **model/** – `medicine_model.dart`  
- **provider/** – `medicine_provider.dart`  
- **screens/** – `add_medicine_screen.dart`, `home_screen.dart`  
- **service/** – `local_database.dart`  
- **widgets/** – Custom reusable widgets (`custom_text_field.dart`, `custome_button.dart`, `custome_time_picker.dart`)  
